...
static void SS_KH_SettingsChanged(CFNotificationCenterRef center, void *observer, CFStringRef name, const void *object, CFDictionaryRef userInfo){
	[SSKHSettingsController loadSettings];
}
...
%ctor{
	...
	%init;
	CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(), NULL, SS_KH_SettingsChanged, CFSTR("com.iky1e.swipeselection/settingschanged"), NULL, CFNotificationSuspensionBehaviorCoalesce);
